...
public class TestApiRestAssured {
    ...
    public static String getToken() {
        token = RestAssured.given()
                ...
                .body(new JSONObject()
                        .put("username", ConfProperties.getPrivateProperty("username"))
                        .put("password", ConfProperties.getPrivateProperty("password"))
                        .toString())
                .log().all()
                .when()
                .post(ConfProperties.getPrivateProperty("login"))
                .then()
                .statusCode(202)
                .extract()
                .path("access_token")
